...
<body>
	...
	<div class="container" id="page-container">
		<div class="row" id="content-wrap">
			...
			<div class="col-xl">
				<div class="card" style="margin-top:100px;width:480px;border-radius: 13px;background-color: skyblue;width:800px">
					<div class="card-body">
						<h4 style="text-align:center;color:#34495E;font-size:23px;" class="pt-2">All Teachers</h4>
						<hr>
						<?php
									...
									<tr>
										...
										<td  style="" >
											<div class="d-inline-block">
												<a href="http://localhost:8002/institute-managment/view_teacher.php?teacher_id=<?php echo $data['id']; ?>"><button type="button" class="btn" style="background-color:#239B56;color:white;font-size: 13px;">View</button> </a>
											</div>
											<span class="d-sm-inline-block">
													<a href="http://localhost:8002/institute-managment/edit_teacher.php?teacher_id=<?php echo $data['id']; ?>"><button type="button" class="btn" style="background-color:#F1C40F;color:white;font-size: 13px;">Edit</button> </a>
													</span>
											<span class="d-sm-inline-block">
												<a href="http://localhost:8002/institute-managment/delete_teacher.php?teacher_id=<?php echo $data['id']; ?>"><button type="button" class="btn" style="background-color:#CB4335;color:white;font-size: 13px;">Delete</button> </a>
											</span>
											<span class="d-sm-inline-block">
       											 <a href="http://localhost:8002/institute-managment/leave1.php?student_id=<?php echo $data['id']; ?>">
            									 <button type="button" class="btn" style="background-color: #3498db; color: white; font-size: 13px;">Leave</button>
    											 </a>
										    </span>
										</td>
									</tr>
